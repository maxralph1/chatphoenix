defmodule ChatphoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatphoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatphoenixWeb.Gettext, "errors", msg, opts)
    end
  end
